...
object MapperListVariant {
     ...
     fun List<Variant>?.toBody(): MutableList<com.iagora.wingman.market.data.remote.body.VariantBody> {
        val listVariantBody = mutableListOf<com.iagora.wingman.market.data.remote.body.VariantBody>()
    ...
    private fun Variant?.toBody() = com.iagora.wingman.market.data.remote.body.VariantBody(
