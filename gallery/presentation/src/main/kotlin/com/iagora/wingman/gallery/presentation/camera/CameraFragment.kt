...
class CameraFragment :
    ...
    private val outputDirectory: String by lazy {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            "${Environment.DIRECTORY_PICTURES}/${requireActivity().packageName}/"
        } else {
            "${requireContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES)}/${requireActivity().packageName}/"
        }
    }
...
//                .setTargetAspectRatio(aspectRatio) // set the camera aspect ratio
                .setTargetResolution(Size(208, 650))
                .build()
            ...
            imageCapture = ImageCapture.Builder()
                ...
                .setTargetResolution(Size(225, 345)) // set the capture aspect ratio
                .build()
