...
private fun provideKeySharedPrefDT() =
    BuildConfig.KEY_SHARED_PREFERENCE_DT

private fun provideBaseURL() = BuildConfig.BASE_URL
private fun provideKeySharedAuth() =
    BuildConfig.KEY_SHARED_PREFERENCE_AUTH

private fun provideKeySharedWingman() =
    BuildConfig.KEY_SHARED_PREFERENCE_WINGMAN_INFO