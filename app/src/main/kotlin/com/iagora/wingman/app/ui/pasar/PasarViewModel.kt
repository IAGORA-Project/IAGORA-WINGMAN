...
//    val listProductPasar: MutableLiveData<EventWrapper<Resource<com.iagora.wingman.market.helper.data.remote.response.ResGetListProductPasar>>> = MutableLiveData()
//    val listTypeAndCategory: MutableLiveData<EventWrapper<Resource<ResGetListTypeAndCategory>>> = MutableLiveData()
//    val addProduct: MutableLiveData<EventWrapper<Resource<com.iagora.wingman.market.helper.data.remote.response.ResAddProduct>>> = MutableLiveData()
...
//
//
//    fun vmGetListProductPasar(idPasar: String): LiveData<EventWrapper<Resource<com.iagora.wingman.market.helper.data.remote.response.ResGetListProductPasar>>> {
//
//
...
//                .enqueue(object : Callback<com.iagora.wingman.market.helper.data.remote.response.ResGetListProductPasar> {
//                    override fun onResponse(
//                        call: Call<com.iagora.wingman.market.helper.data.remote.response.ResGetListProductPasar>,
//                        response: Response<com.iagora.wingman.market.helper.data.remote.response.ResGetListProductPasar>,
//                    ) {
//                        val body = response.body()
//
//                        if (response.code() == 200) {
...
//                    }
//
//                override fun onFailure(call: Call<com.iagora.wingman.market.helper.data.remote.response.ResGetListProductPasar>, t: Throwable) {
...
//
//
//    fun vmAddProduct(addProductBody: com.iagora.wingman.market.helper.data.remote.body.AddProductBody): LiveData<EventWrapper<Resource<com.iagora.wingman.market.helper.data.remote.response.ResAddProduct>>>{
//
//        addProduct.postValue(EventWrapper(Resource.loading("true", null)))
//
//        try {
//            pasarRepository.postAddProduct(addProductBody)
//                .enqueue(object : Callback<com.iagora.wingman.market.helper.data.remote.response.ResAddProduct> {
//                    override fun onResponse(
//                        call: Call<com.iagora.wingman.market.helper.data.remote.response.ResAddProduct>,
//                        response: Response<com.iagora.wingman.market.helper.data.remote.response.ResAddProduct>,
//                    ) {
//                        val body = response.body()
//
//                        if (response.code() == 200) {
...
//                    }
//
//                override fun onFailure(call: Call<com.iagora.wingman.market.helper.data.remote.response.ResAddProduct>, t: Throwable) {
